  ...
  return (
    <div className="div">
      <div className="div-parent">
        <div className="div1">
          <div className="x-your-lead">5x Your Lead Flow</div>
        </div>
        <img className="div-icon" alt="" src="/div@2x.png" />
        <div className="lorem-ipsum-dolor">
          Lorem ipsum dolor sit amet consectetur. Risus sit vel sit in quisque
          neque. Elit amet ut pellentesque purus morbi fringilla. Urna morbi dui
          euismod curabitur ullamcorper aenean tempus nibh.
        </div>
      </div>
      <div className="div2" />
      <Sidebar />
      ...
      <div className="frame-parent">
        <div className="parent">
          <div className="div3">2632</div>
          <div className="connections">Connections</div>
          <div className="vuesaxlineartrend-up-parent">
            <img
              className="vuesaxlineartrend-up-icon"
              alt=""
      ...
      <div className="invitations-sent-parent">
        <div className="b">Invitations sent</div>
        <div className="div4">286</div>
      </div>
      <div className="pending-invitations-parent">
        <div className="b">Pending Invitations</div>
        <div className="div4">12</div>
      </div>
      <div className="profile-views-parent">
        <div className="b">Profile views</div>
        <div className="div4">2891</div>
      </div>
      <div className="frame-group">
        <div className="parent">
          <div className="div3">2667</div>
          <div className="connections">Followers</div>
          <div className="vuesaxlineartrend-up-group">
            <img
              className="vuesaxlineartrend-up-icon"
              alt=""
      ...
      <div className="container">
        ...
        <div className="connections">Connect Invites</div>
        <div className="vuesaxlineartrend-up-container">
          <img
            className="vuesaxlineartrend-up-icon"
            alt=""
      ...
      <div className="ellipse-parent">
        <img className="frame-inner" alt="" src="/ellipse-4@2x.png" />
        <b className="jacob-frost">Jacob Frost</b>
        <img
          className="vuesaxlineararrow-square-dow-icon"
          alt=""
          src="/vuesaxlineararrowsquaredown1.svg"
        />
      </div>
      <img className="item" alt="" src="/group-34146.svg" />
      <div className="chart-parent">
        <div className="chart">
          <img className="polygon-01" alt="" src="/polygon--01.svg" />
          <img className="polygon-02" alt="" src="/polygon--02.svg" />
          <img className="polygon-03" alt="" src="/polygon--03.svg" />
          <img className="polygon-04" alt="" src="/polygon--04.svg" />
          <img className="polygon-05" alt="" src="/polygon--05.svg" />
          <img className="polygon-06" alt="" src="/polygon--06.svg" />
          <img className="polygon-07" alt="" src="/polygon--07.svg" />
          <img className="polygon-08" alt="" src="/polygon--08.svg" />
          <img className="chart-child" alt="" src="/vector-15.svg" />
          ...
          <div className="number-02">
            <div className="div9">20</div>
          </div>
          <div className="number-03">
            <div className="div9">30</div>
          </div>
          <div className="number-04">
            <div className="div9">40</div>
          </div>
          <div className="number-05">
            <div className="div9">50</div>
          </div>
          <div className="number-06">
            <div className="div9">60</div>
          </div>
          <div className="number-07">
            <div className="div9">70</div>
          </div>
          <div className="number-08">
            <div className="div9">80</div>
          </div>
          <div className="number-09">
            <div className="div9">90</div>
          </div>
          <img className="icon" alt="" src="/01.svg" />
          ...
          <img className="chart-item" alt="" src="/vector-16.svg" />
      ...
      <div className="doughnut-parent">
        ...
        <div className="info1">
          <div className="data-01">
            ...
            <div className="txt2">
              <div className="invitations-sent1">Invitations sent</div>
              <div className="data2">
          ...
          <div className="data-01">
            ...
            <div className="txt2">
              <div className="invitations-sent1">Pending invitations</div>
              <div className="data2">
      ...
      <div className="vuesaxlinearcalculator-parent">
        <img
          className="vuesaxlineararrow-square-dow-icon"
          alt=""
          src="/vuesaxlinearcalculator1.svg"
        />
        <div className="b">Mar 10 - Apr 10</div>
        <img
          className="vuesaxlineararrow-square-dow-icon1"
          alt=""
          src="/vuesaxlineararrowsquaredown2.svg"
        />
      </div>
